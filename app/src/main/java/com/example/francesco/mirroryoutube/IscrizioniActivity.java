    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener gestore = new View.OnClickListener() {
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.button1:
                        Intent i1=new Intent(IscrizioniActivity.this, SearchActivity.class);
                        Value=et.getText().toString();
                        i1.putExtra("Name",Value);
                        startActivity(i1);
                        break;
                    case R.id.button7:
                        Intent i2=new Intent(IscrizioniActivity.this, OpzioniActivity.class);
                        i2.putExtra("Id", "id123456789Show");
                        startActivity(i2);
                        break;
                    case R.id.button3:
                        Intent i3=new Intent(IscrizioniActivity.this, HomeActivity.class);
                        i3.putExtra("Id", "id123456789Friends");
                        startActivity(i3);
                        break;
                    case R.id.button4:
                        Intent i4=new Intent(IscrizioniActivity.this, TendenzeActivity.class);
                        startActivity(i4);
                        break;
                    case R.id.button5:
                        Intent i5=new Intent(IscrizioniActivity.this, IscrizioniActivity.class);
                        startActivity(i5);
                        break;
                    case R.id.button6:
                        Intent i6=new Intent(IscrizioniActivity.this, AttivitaActivity.class);
                        startActivity(i6);
                        break;
                    case R.id.button2:
                        Intent i7=new Intent(IscrizioniActivity.this, RaccoltaActivity.class);
                        startActivity(i7);
                        break;
                }
            }
        ...
        final String[] stuff = new String[]{"ItemIscrizioni1", "ItemIscrizioni2", "ItemIscrizioni3", "ItemIscrizioni4", "ItemIscrizioni5", "ItemIscrizioni6"};
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> av, View v, int pos, long id) {
                Intent i = new Intent(IscrizioniActivity.this, ItemListActivity.class);
