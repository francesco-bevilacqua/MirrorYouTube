    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener gestore = new View.OnClickListener() {
            public void onClick(View view) {
                switch(view.getId()) {
                    case R.id.button1:
                        Intent i1=new Intent(HomeActivity.this, SearchActivity.class);
                        Value=et.getText().toString();
                        i1.putExtra("Name",Value);
                        startActivity(i1);
                        break;
                    case R.id.button7:
                        Intent i2=new Intent(HomeActivity.this, OpzioniActivity.class);
                    ...
                    case R.id.button3:
                        ...
                        break;
                    case R.id.button4:
                        Intent i4=new Intent(HomeActivity.this, TendenzeActivity.class);
                        startActivity(i4);
                        break;
                    case R.id.button5:
                        Intent i5=new Intent(HomeActivity.this, IscrizioniActivity.class);
                        startActivity(i5);
                        break;
                    case R.id.button6:
                        Intent i6=new Intent(HomeActivity.this, AttivitaActivity.class);
                        startActivity(i6);
                        break;
                    case R.id.button2:
                        Intent i7=new Intent(HomeActivity.this, RaccoltaActivity.class);
                        startActivity(i7);
                        break;
                }
            }
